// Copyright (c) 2015-2023 Jeevanandam M (user@example.com), All rights reserved.
...
//
// For Example: To set auth token <auth-token-value>
//
//	client.R().SetAuthToken("<auth-token-value>")
//
