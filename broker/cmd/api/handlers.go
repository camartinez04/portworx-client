...
//
// MetricsURL supports a comma-separated list of node endpoints; the broker
// fans out concurrently and returns the result with the highest I/O activity.
...
//
// MetricsURL supports a comma-separated list of node endpoints; the broker
// fans out concurrently and returns the result from the node that owns the nodeID.
