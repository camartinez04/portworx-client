...
RUN go get github.com/go-chi/chi/v5 && go get github.com/go-chi/cors && go get github.com/alexedwards/scs/v2 && go get github.com/justinas/nosurf && go get github.com/libopenstorage/openstorage-sdk-clients/sdk/golang && go get github.com/asaskevich/govalidator
